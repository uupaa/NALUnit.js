...
/*
- Mobile Device supported profile and levels
    - https://github.com/uupaa/M3U.js/wiki/ProfileAndLevels
 */
// --- dependency modules ----------------------------------
...
SPS["prototype"] = Object.create(SPS, {
    "constructor": { "value": SPS            }, // new Spec():Spec
    "getProfile":  { "value": SPS_getProfile }, // SPS.getProfile():AVCProfileString - "Base" or "Main" or "High" or ""
    "getLevel":    { "value": SPS_getLevel   }, // SPS.getLevel():AVCLevelNumber - Lv1.2 - Lv5.1
});
...
function SPS_getProfile() { // @ret AVCProfileString - "Baseline" or "Main" or "Extended" or "High"
    return PROFILES[this["profile_idc"]] || "";
}

function SPS_getLevel() { // @ret AVCLevelNumber - 1.2 - 5.1
    return (this["level_idc"] || 0.0) / 10.0;
}
